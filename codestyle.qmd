...
Style is one of the conventions a team has to agree on once and then stop arguing about. Recording the choice in the team handbook (@sec-onboarding-conventions), and enforcing it automatically rather than in review comments (@sec-peerreview-mechanics), is what keeps it from becoming a recurring discussion.
