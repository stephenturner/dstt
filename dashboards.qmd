...
This chapter covers the Quarto-native approach, where the whole dashboard is a text file under version control. Many public health teams publish through Tableau or Power BI instead, because the license is already paid and the stakeholders already know the interface. @sec-bi covers that case: how to keep the analysis reproducible in R when the presentation layer is a proprietary binary file.
