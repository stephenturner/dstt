...
Both tools pin whatever your project already depends on. Neither one asks whether a dependency was a good idea, and the answer matters most here, because a heavy dependency tree that installs in seconds on a laptop can add fifteen minutes to every container build. @sec-dependencies covers choosing and vetting packages before they reach the lockfile.
