...
The testing, debugging, and API chapters (@sec-testing, @sec-debugging, @sec-apis) include worked examples with the code and explanations together. The targets section (@sec-automation-targets) includes every file needed to build and run a small reporting pipeline.
...
@sec-resources lists further reading and training. @sec-trainingbudget covers choosing paid training and meeting procurement deadlines.
