...
The question that follows immediately is how many packages, and how to split them. Several small ones beat one large one, organized by functionality rather than by data source, for reasons covered in @sec-dependencies-ownpackage.
